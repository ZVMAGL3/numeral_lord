...
void main()
{
    ...
    u_xlat16_1.xyz = (_ManualTex2SRGB != 0) ? u_xlat2.xyz : u_xlat10_0.xyz;
    u_xlat16_10 = u_xlat10_0.w * vs_COLOR0.w;
    SV_Target0.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz;
    u_xlat10_0.x = texture2D(_GUIClipTexture, vs_TEXCOORD1.xy).w;
    u_xlat16_0 = u_xlat10_0.x * u_xlat16_10;
